...
import { PrismaEquipmentRepository } from "./infrastructure/repositories/equipment.repository.js";
import { SensorService } from "./application/asset/sensor.service.js";
import { PrismaSensorRepository } from "./infrastructure/repositories/sensor.repository.js";
...
import { PrismaMaintenanceRecordRepository } from "./infrastructure/repositories/maintenance-record.repository.js";
import { ScheduleService } from "./application/asset/schedule.service.js";
import { PrismaAssetScheduleRepository } from "./infrastructure/repositories/asset-schedule.repository.js";
...
import { PrismaSensorCompatibilityRepository } from "./infrastructure/repositories/sensor-compatibility.repository.js";
...
import { PrismaCustomerRepository } from "./infrastructure/repositories/customer.repository.js";
...
import { PrismaOverseasOrderRepository } from "./infrastructure/repositories/overseas-order.repository.js";
...
import { PrismaImportCostSettlementRepository } from "./infrastructure/repositories/import-cost-settlement.repository.js";
import { InventoryAuditService } from "./application/inventory/inventory-audit.service.js";
import { PrismaInventoryAuditRepository } from "./infrastructure/repositories/inventory-audit.repository.js";
...
// ─── Services ──────────────────────────────────────────────────────────────
const equipmentService = new EquipmentService(new PrismaEquipmentRepository(prisma), prisma);
const sensorService = new SensorService(new PrismaSensorRepository(prisma), prisma);
const categoryService = new CategoryService(new PrismaCategoryRepository(prisma), prisma);
const maintenanceService = new MaintenanceService(new PrismaMaintenanceRecordRepository(prisma), prisma);
const scheduleService = new ScheduleService(new PrismaAssetScheduleRepository(prisma), prisma);
const deploymentService = new DeploymentService(prisma);
const compatibilityService = new CompatibilityService(new PrismaSensorCompatibilityRepository(prisma), prisma);
...
const customerService = new CustomerService(new PrismaCustomerRepository(prisma), prisma);
...
const overseasOrderService = new OverseasOrderService(new PrismaOverseasOrderRepository(prisma), prisma);
...
const importCostService = new ImportCostService(new PrismaImportCostSettlementRepository(prisma), prisma);
