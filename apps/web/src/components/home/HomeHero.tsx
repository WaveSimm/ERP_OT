...
export default function HomeHero() {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950 dark:to-indigo-950 border border-blue-100 dark:border-blue-900 rounded-xl px-6 py-5 mb-5">
      <h1 className="text-xl font-bold text-gray-900">
        안녕하세요, <span className="text-blue-700 dark:text-blue-300">{name || "사용자"}</span>님 👋
      </h1>
